...
$local = mysqli_real_escape_string($conexion, $_POST["Localidad"]);
$tel = mysqli_real_escape_string($conexion, $_POST["Telefono"]);
$cuit = mysqli_real_escape_string($conexion, $_POST["cuit"]);

//Consulta para insertar

$sql = "INSERT INTO Clientes (Empresa, Direccion, Localidad, Telefono, cuit)
VALUES ('$empresa', '$dir', '$local', '$tel', '$cuit')";
