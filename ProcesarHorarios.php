...
<body>
<h1>Formulario de Horarios <br><small>Obtencion de datos</small></h1>
...
/*$fe =  mysqli_real_escape_string($conexion, $_POST["fecha"]);
$nom = mysqli_real_escape_string($conexion, $_POST["nombre"]);
$des = mysqli_real_escape_string($conexion, $_POST["desde"]);
$has = mysqli_real_escape_string($conexion, $_POST["hasta"]);


//Consulta para insertar

$sql = "INSERT INTO horarios (fecha, nombre, desde, hasta)
VALUES ('$fe', '$nom', '$des', '$has')";
*/
...
if (!$resultado) {
	...
	echo 'Error al registrar el Horario del dia';
