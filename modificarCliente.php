...
<pre>
	...
	<?php require('cn.php');
		...
		$vista= " SELECT * FROM Clientes WHERE id='$id'";
	...
	<form action="modificarProcesoCli.php?id=<?php echo $row['id']; ?> " name="Clientes" method="post" class="formulario">
		
	<h1 class="formulario__titulo"><b><u>Modificar Cliente</u></b></h1>
	<br>
