  ...
  <form id="login" class="box" action="">
    <fieldset>
      <legend>Conexión</legend>
        <ul>
          <li><label for="user">Usuario</label><input type="text" id="user" name="user" autocomplete="on" autofocus="on" /></li>
          <li><label for="password">Contraseña</label><input type="password" id="password" name="password" autocomplete="on" /></li>
